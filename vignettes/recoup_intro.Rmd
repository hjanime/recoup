...
vignette: >
  %\VignetteIndexEntry{Introduction to the recoup package}
...
files from [here]
(https://drive.google.com/file/d/0BxxrqIl3Nb0NSVNqdGNPa3M3cnc/view?usp=sharing). 
...
## Building a local annotation store
...
genomic profiles from ChIP-Seq or RNA-Seq data can be found either [here]
(http://epigenomics.fleming.gr/~panos/recoup_tutorial) or in the wiki `recoup` 
pages in [github](https://github.com/pmoulos/recoup/wiki/Introduction-to-recoup)
...
can also be found in the github package [page](https://github.com/pmoulos/recoup)
with a little more examples.
